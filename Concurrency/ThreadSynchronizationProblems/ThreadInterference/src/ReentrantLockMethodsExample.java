...
// Instead of using an intrinsic lock via the synchronized keyword, you can also use various Locking classes provided
// by Java’s Concurrency API to have more fine-grained control over the locking mechanism.
